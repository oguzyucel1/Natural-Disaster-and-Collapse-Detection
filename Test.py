...
exit_button.place(relx=0.70, rely=0.85)  # Move Exit button to the left
...
radiobutton_webcam = Radiobutton(root, text="Webcam", variable=selected_mode, value="Webcam", command=toggle_mode, bg="white", font=("Helvetica", 12))
radiobutton_webcam.place(relx=0.01, rely=0.01)

radiobutton_folder = Radiobutton(root, text="Folder", variable=selected_mode, value="Folder", command=toggle_mode, bg="white", font=("Helvetica", 12))
